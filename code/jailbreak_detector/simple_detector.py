#!/usr/bin/env python3
"""
Simplified Jailbreak Detector with minimal dependencies
"""
import os
import argparse
import torch
...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Simplified Jailbreak Detector")
...
def load_model_and_tokenizer(model_name, device):
    ...
    try:
        # Most basic model loading without any extra parameters
